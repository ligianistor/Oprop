...
if ( opp!=null) {
 fracLeft[ opp] := fracLeft[ opp] / 2.0;
}
if ( opp!=null) {
 fracRight[ opp] := fracRight[ opp] / 2.0;
}
if ( opp!=null) {
...
if ( opp!=null) {
 fracCount[ opp] := fracCount[ opp] + 0.001;
}
fracLeft[ this] := fracLeft[ this] + 0.0;
fracRight[ this] := fracRight[ this] + 0.0;
